...
public class IHMTestEnsemble extends JFrame implements ActionListener {
    ...
    private void initComponents() {// GEN-BEGIN:initComponents
        ...
        button1.addActionListener(this  // à compléter, par une instance de
        ...
        button2.addActionListener(this  // à compléter, par une instance de
                                        // classe anonyme,
        ...
        button3.addActionListener(this  // à compléter, par une instance de
                                        // classe anonyme, usage de
        ...
        button4.addActionListener(
           this                                                                            // diffSymetriqueActionPerformed voir en
                                                                                            // bas de page
        );
    ...
    public void actionPerformed(ActionEvent ae){
        String evtText = ae.getActionCommand();
        if(evtText.equalsIgnoreCase("diffSymetrique")){
            this.diffSymetriqueActionPerformed(ae);
        }
        if(evtText.equalsIgnoreCase("difference")){
            this.differenceActionPerformed(ae);
        }
        if(evtText.equalsIgnoreCase("intersection")){
            this.intersectionActionPerformed(ae);
        }
        if(evtText.equalsIgnoreCase("union")){
            this.unionActionPerformed(ae);
        }
    }
